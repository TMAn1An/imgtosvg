...
def main(argv=None):
    ...
    ap.add_argument("--mode", choices=["designer", "outline", "stroke", "auto"], default="designer",
                    help="designer = clean line icon with a light even weight (default), "
                         "outline = filled shapes (Vector Magic style), stroke = designer with the image's weight")
