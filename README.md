...
7. **ভরাট অংশ**: রেন্ডার করে মিলিয়ে দেখে কোথাও ink-এর পুরো একটা অংশ বাদ পড়লে (যেমন ভরাট টাই, কম্পাসের কাঁটা) সেটা fill করে দেয়
8. Auto মোড stroke রেজাল্ট রেন্ডার করে ইনপুটের সাথে মিলিয়ে দেখে; না মিললে outline দেয়
