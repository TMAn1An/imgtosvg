...
### যা আপনার icon_tool থেকে নেওয়া হয়েছে
- ডিফল্ট মডেল **`gemini-flash-lite-latest`** (ফ্রি টিয়ারে সবচেয়ে বেশি কোটা, আপনার টুলে এটাই কাজ করে)
- Google-এর অফিসিয়াল `google-genai` লাইব্রেরি দিয়ে কল (আপনার টুলের মতোই)
- **একাধিক key**: key বক্সে কমা দিয়ে কয়েকটা key দিন, একটার কোটা শেষ হলে পরেরটা নিজে থেকে চলবে
- AI ব্যর্থ হলে (কোটা/নেটওয়ার্ক) কার্ডে এরর দেখায় আর **অফলাইন Designer-এর SVG** দিয়ে দেয়, খালি হাতে ফেরায় না
...
6. **Anchor পরিষ্কার**: লাইনের মোটার চেয়ে কাছাকাছি দুটো anchor একটায় মেলানো (ছোট গোল কোণা → একটা পরিষ্কার কোণা),
   মসৃণ curve-এর বাড়তি anchor বাদ, তারপর আবার ink-এর মাঝখানে বসানো
7. **কোণা, সোজা লাইন, পুনরাবৃত্তি** (প্রতিটা সিদ্ধান্ত রেন্ডার করে ink-এর সাথে মিলিয়ে):
   কোণা sharp হবে নাকি গোল আর কতটা গোল; প্রায়-সোজা curve আসলে সোজা লাইন কিনা; প্রায় খাড়া/আনুভূমিক লাইন
   একদম খাড়া/আনুভূমিক; দুই অংশের একই কিনারা দুবার আঁকা হলে একটায় মেলানো; একই রকম অংশ (পিন, জানালা,
   মানুষ) একবার এঁকে হুবহু কপি
8. **ভরাট অংশ**: রেন্ডার করে মিলিয়ে দেখে কোথাও ink-এর পুরো একটা অংশ বাদ পড়লে (যেমন ভরাট টাই, কম্পাসের কাঁটা) সেটা fill করে দেয়
9. Auto মোড stroke রেজাল্ট রেন্ডার করে ইনপুটের সাথে মিলিয়ে দেখে; না মিললে outline দেয়
